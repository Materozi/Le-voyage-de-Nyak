...
var platformHeight = canvas.height - platformWidth*6;  // bottom row of the game
//espace entre les plateforme
...
var assetLoader = (function() {
  ...
  this.imgs        = {
    'bg'            : 'imgs/bg.png',
    'sky'           : 'imgs/backdrop_ground.png',
    'backdrop2'     : 'imgs/ciel.png',
    'grass'         : 'imgs/grass.png',
    'avatar_normal' : 'imgs/nyak_marche.png',
...
function Animation(spritesheet, frameSpeed, startFrame, endFrame) {
  ...
  this.update = function() {
    ...
    if (counter == (frameSpeed - 1))
      currentFrame = (currentFrame + 2) % animationSequence.length;
...
var player = (function(player) {
  ...
  // spritesheets
  player.sheet     = new SpriteSheet('imgs/nyak_marche.png', player.width, player.height);
